                    ...
                    else if (number_m == 2)
                    {
                        ...
                        for (int i = 0; i < size_Land_Vehicle_array - 1; i++)
                        {
                            for (int j = 0; j < size_Land_Vehicle_array - i - 1; j++)
                            {
                                ...
                                double m_first = ptrArray[j]->RoadСalculation(m_Distance);

                                double m_second = ptrArray[j + 1]->RoadСalculation(m_Distance);
                        ...
                        for (int i = 0; i < size_Land_Vehicle_array; i++)
                        {
                            ...
                            {
                                double result = ptrArray[i]->RoadСalculation(m_Distance);
